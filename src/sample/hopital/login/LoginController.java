...
import sample.hopital.models.User;
    ...
    private void completeLogin() {
        ...
        if (isValidInput()) {
            try {
                ...
                scene.getStylesheets().add(sample.hopital.hospitalfx.HospitalFX.class.getResource("../styles/styles.css").toExternalForm());
