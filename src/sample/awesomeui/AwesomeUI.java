...
public class AwesomeUI extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        StackPane root = new FXMLLoader(getClass().getResource("resources/principal.fxml")).load();
        ...
        StackPane rootLogin = new FXMLLoader(getClass().getResource("resources/login.fxml")).load();
