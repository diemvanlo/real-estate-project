package sample.awesomeui.components;

import sample.awesomeui.animation.FadeInDownTransition;
...
public class FloatMenu extends StackPane implements Initializable {
    ...
    private void LoadMenu() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/menu_float.fxml"));
