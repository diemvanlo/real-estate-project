...
(N'Đỗ Văn Liêm','VanLiem','123',N'Quảng bình','0968555678','VanLiem@gmail.com','true',N'Giám Đốc',0),
(N'Nguyễn Thế Công','TheCong','123',N'Quảng bình','0522355667','thecong@gmail.com','true',N'Nhân Viên',2),
...
(N'Chung cư AAA',N'Chung Cư',N'325 Ngô Văn Sở',78,23,'2017-05-29','',N'Chung Cư',N'góp vốn',1,N'Đang xây dựng',232,1112,5645),
(N'Chung cư Liên Chiểu',N'Chung Cư',N'108 Bắc Tính',112,550,'2017-05-12','',N'Chung Cư',N'góp vốn',6,N'Đang xây dựng',698,786,7886),
(N'Chung cư KHD',N'Chung Cư',N'08 Hà Huy Tập',7887,5345,'2019-09-02','',N'Chung Cư',N'góp vốn',8,N'Đang xây dựng',788,65,566),
(N'Chung cư UIO',N'Chung Cư',N'699 Hà Huy Tập',655,868,'2019-08-02','',N'Chung Cư',N'góp vốn',5,N'Đang xây dựng',54545,5566,788),
(N'Chung cư Hòa Khánh',N'Chung Cư',N'08 Bạch Đằng',785,988,'2015-05-02','',N'Chung Cư',N'góp vốn',2,N'Đang xây dựng',7878,686,4545),
(N'Chung cư Hòa Minh',N'Chung Cư',N'32 Nam Sơn',112,565,'2017-05-02','',N'Chung Cư',N'góp vốn',4,N'Đang xây dựng',5963,6565,786),
(N'Đất nền HA Nam',N'Đất nền',N'56 Hà văn Nam',533,785,'2017-05-09','',N'Đất nền',N'góp vốn',1,N'Đang xây dựng',213,355,532),

(N'Chung cư ABCD',N'Chung Cư',N'08 Hà văn Tính',112,550,'2017-05-02','',N'Chung Cư',N'góp vốn',1,N'Đang xây dựng',54545,6565,4545),
(N'Chung cư sa',N'Chung Cư',N'03 Hà văn Ngọc',4545,10289,'2019-01-02','',N'Chung Cư',N'góp vốn ',1,N'Đang xây dựng',85698,5454,87887);
...
(N'Phòng 02',2,N'03 Hà Văn Ngọc',40,390,N'đang xây dựng','2019-03-02','',N'phòng đầy đủ tiện nghi',N'chưa bán',2);
